class SuperAdmin::AccountsController < SuperAdmin::ApplicationController
  ...
  def destroy
    ...
    Openchat::BridgeClient.new.teardown_account(account_id: account.id)
  rescue Openchat::BridgeClient::Error => e
    Rails.logger.warn("[OpenChat] account teardown skipped: #{e.message}")
  ensure
