...
import OpenclawWhatsapp from './openchat/Whatsapp.vue';
...
const availableProviders = computed(() => [
  ...
  {
    key: PROVIDER_TYPES.OPENCLAW,
    title: 'Connect via OpenClaw',
    description:
      'Scan a QR code with your phone — best for a personal number or a small business without a Meta Business account.',
...
<template>
  <div class="col-span-6 w-full h-full min-h-0 overflow-y-auto p-6">
    ...
    <div v-else-if="showConfiguration">
      <div
        v-if="selectedProvider === PROVIDER_TYPES.OPENCLAW"
        class="px-6 py-5 rounded-2xl border border-n-weak"
      >
        <OpenclawWhatsapp />
      </div>
