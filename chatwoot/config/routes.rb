        ...
        scope module: :accounts do
          ...
          resource :openchat, only: [], controller: 'openchat' do
            collection do
              ...
              post :whatsapp_compose
              post :model_auth
              get 'knowledge', action: :knowledge_index
              ...
              put 'openclaw_workspace/:file', action: :update_openclaw_workspace_file, constraints: { file: /[\w.\-]+/ }, format: false
            end
          end
