...
const getOpenChatHttpModule = createLazyRuntimeModule(() => import("./openchat-http.js"));
...
export function createGatewayHttpServer(opts: {
  ...
  async function handleRequest(
    ...
    try {
      ...
      addAdmittedStage(scopedRequestPath.startsWith("/openchat/"), async () =>
        (await getOpenChatHttpModule()).handleOpenChatHttpRequest(req, res, routeAuth),
      );
